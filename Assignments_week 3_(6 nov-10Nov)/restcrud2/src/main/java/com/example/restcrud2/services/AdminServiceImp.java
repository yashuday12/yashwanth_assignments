...
public class AdminServiceImp implements IAdminService {
	...
	@Override
	public List<Admin> getAdminSorted(int adminId) {
		// TODO Auto-generated method stub
		return repo.getAdminSorted(adminId);
	}
   
	public static boolean inputValidation(Admin admin) {
		boolean flag=false;
		if(admin.getAdminName().length() >3) {
			flag=true;
		}
		else {
			flag=false;
